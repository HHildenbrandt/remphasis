#ifndef EMPAHSIS_DYN_WRAPPER_HPP_INCLUDED
#define EMPAHSIS_DYN_WRAPPER_HPP_INCLUDED
...
namespace dll {
  ...
  public:
    ...
    FPTR get_address(const char* fname)
    {
      FPTR fptr = reinterpret_cast<FPTR>(GetProcAddress(hModule_, fname));
      if (nullptr == fptr) throw emphasis::emphasis_error("Can't load function address");
      return fptr;
    }
